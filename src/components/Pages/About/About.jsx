            ...
            <section id='aboutUsSection' className='about-us-section'>
                <div className='containerAlignSpace'>
                    <div className='aboutMainSpace'>
                        <div className='about-content w-75 mx-auto' data-aos="zoom-in" data-aos-duration="1300">
                        ...
                        <div className='mt-5 row row-cols-1 row-cols-md-3 p-0 m-0'
                            id='aboutUsFeatures'>
                            <div className="col feature-column" data-aos="fade-right" data-aos-duration="1200">
                                <div>
                                    <h5>About Us</h5>
                            ...
                            <div className="col p-0" data-aos="zoom-in" data-aos-duration="1200">
                                <img src={containerImgForStrategy} alt="Our Strategy" />
                            </div>
                            <div className="col feature-column" data-aos="fade-left" data-aos-duration="1200">
                                <div>
                                    <h5>Our Strategy</h5>
                            ...
                            <div className="col p-0" data-aos="zoom-in-right" data-aos-duration="1200">
                                <img src={mission} alt="Our Mission" />
                            </div>
                            <div className="col feature-column" data-aos="flip-up" data-aos-duration="1200">
                                <div>
                                    <h5>Our Mission</h5>
                            ...
                            <div className="col p-0" data-aos="zoom-in-left" data-aos-duration="1200">
                                <img src={warehouseImg} alt="Warehouse" />
                            </div>
                        </div>
                        <div className='booking-Part' id='bookingSection'>
                            <div className='row p-0 m-0'>
                                <div className='col-md-9 bg-white' data-aos="fade-right" data-aos-duration="1200">
                                ...
                                <div className='col-md-3 bg-white d-flex justify-content-center align-items-center' data-aos="fade-left" data-aos-duration="1200">
