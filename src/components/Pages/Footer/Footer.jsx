                ...
                <div className='containerAlignSpace'>
                    <footer className="footer-container">
                        <div className='row' id="footerContent">
                            <div className="social-links-container col-md-5 col-lg-4 mb-5 mb-md-0">
                                ...
                                <div className='social-links'>
                                    <Link to="https://www.facebook.com/share/3gjEqfj2ahAYFS25/?mibextid=qi2Omg" target="_blank" rel="noopener noreferrer" className="social-link"><FaFacebook /></Link>
                                    <Link to="https://www.linkedin.com/in/bharattrade-international-63a7282b8?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" target="_blank" rel="noopener noreferrer" className="social-link"><FaLinkedin /></Link>
                        ...
                        <div className='copyright-section mt-3' id="copyrightSection">
                            <p className="copyright mb-0">&copy; {new Date().getFullYear()} Bharat Trade International. All Rights Reserved.</p>
                        </div>
                    </footer>
                </div>
            </section>
